...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_adapter/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_adapter"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "42f1ea07f0731cc1e8b5e35821c88913490708fd"
S = "${WORKDIR}/git"
