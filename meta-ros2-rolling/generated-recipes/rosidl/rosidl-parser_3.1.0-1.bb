...
# matches with: https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_parser/3.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rosidl_parser"
SRC_URI = "git://github.com/ros2-gbp/rosidl-release;${ROS_BRANCH};protocol=https"
SRCREV = "1892db275ac7e6063995360737f590ec9e85b03a"
S = "${WORKDIR}/git"
