...
# matches with: https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_pytest/0.23.1-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/launch_pytest"
SRC_URI = "git://github.com/ros2-gbp/launch-release;${ROS_BRANCH};protocol=https"
SRCREV = "5dd3d839dba95584b3b7d9a0714ab3d4fe8d06f7"
S = "${WORKDIR}/git"
