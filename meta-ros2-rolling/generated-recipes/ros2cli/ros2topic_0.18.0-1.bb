...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.18.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2topic"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "f826f306fb7d2eb5d5df9e0c2ded6c1ef1d274a7"
S = "${WORKDIR}/git"
