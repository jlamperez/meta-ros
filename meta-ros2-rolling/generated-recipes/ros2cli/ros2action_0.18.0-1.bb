...
# matches with: https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.18.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/ros2action"
SRC_URI = "git://github.com/ros2-gbp/ros2cli-release;${ROS_BRANCH};protocol=https"
SRCREV = "8fbd0b7ef8d1d6c352b64165551d9ed27602cb57"
S = "${WORKDIR}/git"
