...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bond_core/3.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bond_core"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "8a1ec1bdce3d54522624261eb77cdb2d2433cd98"
S = "${WORKDIR}/git"
