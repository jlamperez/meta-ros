...
# matches with: https://github.com/ros2-gbp/bond_core-release/archive/release/rolling/bondcpp/3.0.1-4.tar.gz
ROS_BRANCH ?= "branch=release/rolling/bondcpp"
SRC_URI = "git://github.com/ros2-gbp/bond_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "2b71e4cf732d75b885678c5132a17f80d809be90"
S = "${WORKDIR}/git"
