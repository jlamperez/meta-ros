...
# matches with: https://github.com/ros2-gbp/rmw_dds_common-release/archive/release/rolling/rmw_dds_common/1.5.0-1.tar.gz
...
SRCREV = "e34af588a7bda7db1c1487d47ddee01771a1de23"
S = "${WORKDIR}/git"
