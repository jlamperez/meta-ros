...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/rolling/iceoryx_posh/1.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/iceoryx_posh"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "e3f8d6be255fbd67786bcf8ea6693631e1fde755"
S = "${WORKDIR}/git"
