...
# matches with: https://github.com/ros2-gbp/iceoryx-release/archive/release/rolling/iceoryx_utils/1.0.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/iceoryx_utils"
SRC_URI = "git://github.com/ros2-gbp/iceoryx-release;${ROS_BRANCH};protocol=https"
SRCREV = "d2d68164ea089b3e0373b9d66728268ebaab1ab9"
S = "${WORKDIR}/git"
