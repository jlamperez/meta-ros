...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/zstd_vendor/0.13.0-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/zstd_vendor"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "b83b3ffdb1b41494ad07df56c8d6e7b291660f2a"
S = "${WORKDIR}/git"
