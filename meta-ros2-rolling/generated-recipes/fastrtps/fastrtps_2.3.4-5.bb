...
# matches with: https://github.com/ros2-gbp/fastrtps-release/archive/release/rolling/fastrtps/2.3.4-5.tar.gz
ROS_BRANCH ?= "branch=release/rolling/fastrtps"
SRC_URI = "git://github.com/ros2-gbp/fastrtps-release;${ROS_BRANCH};protocol=https"
SRCREV = "4e0ae0be7d694605360558169c6ef804874e9ce6"
S = "${WORKDIR}/git"
