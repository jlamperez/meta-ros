...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/rolling/kdl_parser/2.6.1-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "97108113865023705bfce0799751cefa399b1ee2"
S = "${WORKDIR}/git"
