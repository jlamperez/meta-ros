...
# matches with: https://github.com/ros2-gbp/rot_conv_lib-release/archive/release/rolling/rotconv/1.0.5-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rotconv"
SRC_URI = "git://github.com/ros2-gbp/rot_conv_lib-release;${ROS_BRANCH};protocol=https"
SRCREV = "1429ef298e70b577b2b1a70a37302c809f97c2e6"
S = "${WORKDIR}/git"
