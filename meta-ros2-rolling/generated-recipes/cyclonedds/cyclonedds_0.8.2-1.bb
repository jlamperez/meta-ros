...
# matches with: https://github.com/ros2-gbp/cyclonedds-release/archive/release/rolling/cyclonedds/0.8.2-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/cyclonedds"
SRC_URI = "git://github.com/ros2-gbp/cyclonedds-release;${ROS_BRANCH};protocol=https"
SRCREV = "a4fa4fff6e7fdcf81b2a4b039aa069732415f802"
S = "${WORKDIR}/git"
