...
# matches with: https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.1.2-2.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rqt_py_common"
SRC_URI = "git://github.com/ros2-gbp/rqt-release;${ROS_BRANCH};protocol=https"
SRCREV = "d47a03ef5c4769b0491705b81412c50f7f54599f"
S = "${WORKDIR}/git"
