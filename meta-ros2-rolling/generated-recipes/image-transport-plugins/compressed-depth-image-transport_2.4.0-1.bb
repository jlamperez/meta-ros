...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/compressed_depth_image_transport/2.4.0-1.tar.gz
...
SRCREV = "9252a5fb62ade206492b0893a068674be9a9cdee"
S = "${WORKDIR}/git"
