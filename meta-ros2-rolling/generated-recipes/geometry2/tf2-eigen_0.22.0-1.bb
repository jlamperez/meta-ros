...
# matches with: https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_eigen/0.22.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/tf2_eigen"
SRC_URI = "git://github.com/ros2-gbp/geometry2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d8e965ce8e48c4db381655a50eb3bf4dcae99077"
S = "${WORKDIR}/git"
