...
# matches with: https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_assimp_vendor/11.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/rviz_assimp_vendor"
SRC_URI = "git://github.com/ros2-gbp/rviz-release;${ROS_BRANCH};protocol=https"
SRCREV = "a16ed8a4b2042bf50ca4f6a175bf68c7210fefaf"
S = "${WORKDIR}/git"
