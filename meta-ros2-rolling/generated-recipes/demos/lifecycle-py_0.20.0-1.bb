...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/lifecycle_py/0.20.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/lifecycle_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "9dad2fb29b66f344b46ac147fb0a12a97bd80c6f"
S = "${WORKDIR}/git"
