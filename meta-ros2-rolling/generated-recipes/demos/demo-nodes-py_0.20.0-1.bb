...
# matches with: https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_py/0.20.0-1.tar.gz
ROS_BRANCH ?= "branch=release/rolling/demo_nodes_py"
SRC_URI = "git://github.com/ros2-gbp/demos-release;${ROS_BRANCH};protocol=https"
SRCREV = "e640d29dc4d98d3d76366033b58a4b2ed8df5f6a"
S = "${WORKDIR}/git"
