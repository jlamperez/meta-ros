...
# matches with: https://github.com/ros2-gbp/apriltag-release/archive/release/rolling/apriltag/3.1.5-3.tar.gz
ROS_BRANCH ?= "branch=release/rolling/apriltag"
SRC_URI = "git://github.com/ros2-gbp/apriltag-release;${ROS_BRANCH};protocol=https"
SRCREV = "0236b0514472b9a1131df249d3bbe301bd7a306c"
S = "${WORKDIR}/git"
